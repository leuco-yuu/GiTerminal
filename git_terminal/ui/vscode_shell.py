...
class TopCommandBar(QFrame):
    def __init__(self) -> None:
        ...
        self.command_center.setFixedWidth(260)
...
class SidePanel(QFrame):
    def __init__(self, title: str, side: str = "left", min_size: int = 220) -> None:
        ...
        self.header_layout.setContentsMargins(8, 0, 6, 0)
        ...
        self.collapse_button.setMinimumSize(0, 22)
        self.collapse_button.setMaximumSize(22, 22)
